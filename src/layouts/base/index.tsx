  ...
  return (
    <div className="min-h-screen bg-main flex flex-col">
      ...
      <footer className="fixed bottom-0 left-0 right-0 bg-muted border-t border-main/10 py-3 px-4">
        <div className="container mx-auto max-w-3xl flex flex-col md:flex-row items-center justify-between text-main/80">
          <span className="text-sm mb-4 md:mb-0">An experiment to learn Canvas</span>
